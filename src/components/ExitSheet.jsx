...
import { Printer, Calendar, MapPin, Users, CheckSquare, Square, Filter, Tent } from 'lucide-react';
...
export default function ExitSheet({ participants, groups }) {
    ...
    return (
        <div className="exit-sheet-container" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="print-only" style={{ display: 'none', fontFamily: 'Arial, sans-serif', color: 'black' }}>
                ...
                <div style={{ border: '1px solid #000', display: 'flex', flexWrap: 'wrap' }}>
                    {/* Create a grid with fixed cells to match the look */}
            ...
            <style>{`
                @media print {
                    ...
                    .app-container, .main-content, .workspace-area { margin: 0 !important; padding: 0 !important; overflow: visible !important; height: auto !important; width: 100% !important; }
                }
            `}</style>
        </div>
    );
