...
export default function Home({
    ...
    return (
        <div className="animate-fade-in" style={{ padding: '0.5rem', width: '100%', maxWidth: '1100px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            {/* ── Header ── */}
            <div>
                <span className="kicker hero-up" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.45rem', color: 'var(--text-muted)', marginBottom: isMobile ? '0.35rem' : '0.7rem', animationDelay: '0ms' }}>
                    <Clock size={13} strokeWidth={3} /> {formattedDate}
                </span>
                <h2 className="hero-up" style={{ fontFamily: 'Bricolage Grotesque, sans-serif', fontSize: isMobile ? '1.6rem' : 'clamp(1.9rem, 5vw, 3rem)', fontWeight: '800', margin: 0, letterSpacing: '-0.045em', display: 'flex', alignItems: 'center', gap: '0.625rem', animationDelay: '90ms' }}>
