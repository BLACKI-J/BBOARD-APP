...
echo "   1. Définir le code PIN Direction (4 chiffres) dans .env :"
echo "        INITIAL_ADMIN_PIN=4827   (votre code)"
echo "   2. Déployer :        bash bboard.sh up      (Docker, port 8080)"
echo "      ou en local :     bash bboard.sh dev     (Front 5173 / Back 3001)"
echo "--------------------------------------------------------"
