const fs = require('fs');
const file = '/home/jathur/projects/colo-app/src/components/MedsPdfExport.jsx';

const newMedsPdfExport = `import React from 'react';
...
fs.writeFileSync(file, newMedsPdfExport);
console.log('Update MedsPdfExport complete');
